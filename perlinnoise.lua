...
local grad = function(hash, x,y,z)
  return dot_product[BIT.bit32.band(hash,0xF)](x,y,z)
end
...
perlin.noise = function(self,x,y,z)
  ...
  local xi = BIT.bit32.band(math.floor(x),255)
  local yi = BIT.bit32.band(math.floor(y),255)
  local zi = BIT.bit32.band(math.floor(z),255)
